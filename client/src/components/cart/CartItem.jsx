	...
	return(
		<Component>
			...
			<Box style={{ margin: 20 }}>
				...
				<SmallText>Seller:NaturalFarms
					<Box component="span"><img src={fassured} alt="agri-tech" style={{ width: 60, margin: 10}} /></Box>
				</SmallText>
				<Typography style= {{ margin: '20px 0'}}>
					<Box component="span" style={{ fontWeight: 600, fontSize: 18 }}>₹{item.price.cost}</Box>&nbsp; &nbsp; &nbsp;
					<Box component="span" style={{ color:'#878787' }}><strike>₹{item.price.mrp}</strike></Box>&nbsp; &nbsp; &nbsp;
					<Box component="span" style={{ color: '#3883EC' }}>₹{item.price.discount}off</Box>
			</Typography>
